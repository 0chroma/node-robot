...
MotorAdapter.prototype._getOutputSequence = function(a,b,c,d){
  ...
  var body_a = !a ? "" : OUTPUT_DELIMITER + this._getHexOutput(a) + OUTPUT_BODY + "301000000830100000040";
  var body_b = !b ? "" : OUTPUT_DELIMITER + this._getHexOutput(b) + OUTPUT_BODY + "302000000830200000040";
  var body_c = !c ? "" : OUTPUT_DELIMITER + this._getHexOutput(c) + OUTPUT_BODY + "303000000830300000040";
  var body_d = !d ? "" : OUTPUT_DELIMITER + this._getHexOutput(d) + OUTPUT_BODY + "304000000830400000040";
