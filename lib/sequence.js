...
Sequence.prototype.once = function(condition, fn, interval){
  interval = interval || 50; //default interval
  ...
  this.steps.push({condition: condFn, fn: fn, interval: interval});
  return this;
}
...
Sequence.prototype.run = function(){
  ...
  this._run(0, this.steps, function(){
    this.executing = false;
    this.emit("completed", this.interrupted);
